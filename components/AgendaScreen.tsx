    ...
    render() {
        return (
            ...
            <Agenda
                ...
                theme={{ dotColor: '#ba856f', agendaDayTextColor: '#ba856f', agendaDayNumColor: '#ba856f', agendaTodayColor: '#ba856f', agendaKnobColor: '#ba856f', selectedDayBackgroundColor: '#ba856f', todayTextColor: '#ba856f' }}
            />
                <TouchableOpacity>
                    <Text>+</Text>
                </TouchableOpacity>
    ...
    events = (day: DateData) => {
        ...
        setTimeout(() => {
            ...
            items[new Date().toISOString().split('T')[0]] = [
                {name: 'Cours avec les M1 - Dev', height: 75, day: new Date().toString().split('GMT')[0].trimEnd().slice(0,-3)},
                {name: 'Cours avec les M2 - UX/UI', height: 75, day: (new Date().toString().split('GMT')[0]).trimEnd().slice(0,-3)},
            ];
